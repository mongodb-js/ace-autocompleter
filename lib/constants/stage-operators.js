...
const STAGE_OPERATORS = [
  ...
  },
  {
    ...
    comment: '/**\n * index: The name of the Search index.\n * text: Analyzed search, with required fields of query and path, the analyzed field(s) to search.\n * facet: {\n *   facets: {\n *     stringFacet: Filers search results based on unique string values, with required fields of query and path.\n *     numberFacet: Filers search results by breaking them up into separate ranges of numbers, with required fields of query, path, and boundaries.\n *     dateFacet: Filers search results by breaking them up into separate ranges of dates, with required fields of query, path, and boundaries.\n *   }\n * }\n */\n',
    snippet: '{\n  index: ${1:string},\n  operator: {\n    text: {\n      query: ${2:string},\n      path: ${3:string}\n    }\n  },\n  facet: {\n    facets: {\n      ${4:stringFacet}: {\n        type: ${5:string},\n        path: ${6:string},\n        numBuckets: ${7:integer}\n      },\n      numberFacet: {\n        type: \'number\',\n        path: ${8:string},\n        boundaries: [${9:lowerbound}, ${10:lowerbound}, ...],\n        default: ${11:string}\n      },\n      dateFacet: {\n        type: \'date\',\n        path: ${12:string},\n        boundaries: [${13:lowerbound}, ${14:lowerbound}, ...],\n        default: ${15:string}\n      }\n    }\n  }\n}'
  },
  {
    name: '$set',
    value: '$set',
