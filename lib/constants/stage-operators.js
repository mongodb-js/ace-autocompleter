...
const STAGE_OPERATORS = [
  ...
  },
  {
    ...
    meta: 'stage',
    version: '3.4.0',
    description: 'Applies an expression to each element in an array and combines them into a single value.',
    comment: '/**\n * input - Any valid expression that\n *   evaluates to an array.\n * initialValue - The initial value.\n * in - The expression to apply.\n */\n',
