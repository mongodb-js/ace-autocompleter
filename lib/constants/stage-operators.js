...
const STAGE_OPERATORS = [
  {
    ...
    version: '4.4.0',
    description: 'Execute a user defined aggregate function.',
    comment: '/**\n * init: The state initialization function.\n * initArgs: The initialization function arguments.\n * accumulate: The accumulation function.\n * accumulateArgs: The accumulation function arguments.\n * merge: The merge function.\n * finalize: The finalize function.\n lang: The language.\n*/\n',
    snippet: '{\n  init: ${1:init},\n  initArgs: ${2:initArgs},\n  accumulate: ${3:accumulate},\n accumulateArgs: ${4:accumulateArgs},\n merge: ${5:merge},\n  finalize: ${6:finalize},\n lang: \'js\'\n}'
  },
  {
    name: '$addFields',
    value: '$addFields',
  ...
  },
  {
    ...
    comment: '/**\n * body: The first output field.\n * args: The arguments.\n * lang: The language. (\'js\' only)\n */\n',
    snippet: '{\n  body: ${1:body},\n  args: ${2:args},\n  lang: \'js\'\n}'
  },
  {
    name: '$geoNear',
